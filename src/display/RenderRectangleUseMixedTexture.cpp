...
RenderRectangleUseMixedTexture::RenderRectangleUseMixedTexture(std::string Name) : RenderData()
{
    this->Vertices = 
    {
...
void RenderRectangleUseMixedTexture::ConfigData(unsigned int& VAO, unsigned int& VBO, unsigned int& EBO)
{
...
void RenderRectangleUseMixedTexture::Draw()
{
